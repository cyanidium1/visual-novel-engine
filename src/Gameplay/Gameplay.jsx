...
const Gameplay = () => {
  ...
  const [history, updHistory] = useState([["p0", inventory]]);
  ...
  const b1 = () => {
    ...
    updHistory((history) => [...history, [plot[frame].f1, inventory]]);
    console.log(history);
  };
  const b2 = () => {
    ...
    updHistory((history) => [...history, [plot[frame].f2, inventory]]);
  };
  const b3 = () => {
    ...
    updHistory((history) => [...history, [plot[frame].f3, inventory]]);
